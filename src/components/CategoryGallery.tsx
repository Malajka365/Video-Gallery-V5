...
const CategoryGallery: React.FC = () => {
  ...
  // Create URLs with current filters
  const createUrlWithFilters = (path: string) => {
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <Link
              to={createUrlWithFilters(`/${category}/upload`)}
            ...
            <Link
              to={createUrlWithFilters(`/${category}/manage`)}
            ...
            <Link
              to={createUrlWithFilters(`/${category}/tags`)}
